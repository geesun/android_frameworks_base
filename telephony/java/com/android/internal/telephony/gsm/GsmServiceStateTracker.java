...
//Geesun
import com.android.internal.telephony.PlmnOverride;
...
final class GsmServiceStateTracker extends ServiceStateTracker {
    ...
    protected void updateSpnDisplay() {
        ...
        PlmnOverride plmnOver = new PlmnOverride();
    
        //Log.e("Geesun", "spn = " + spn + ",rule =" + rule);

        String carrier =  ss.getOperatorNumeric()
                   + "_" + loc.getLanguage() + "_" +loc.getCountry();
        if (plmnOver.containsCarrier(carrier )) {
            plmn = plmnOver.getPlmn(carrier);
