...
//  private static final String LOG_TAG = "RecentApplicationsDialog";
    ...
    public void onClick(View v) {
        ...
        if(v == mTaskBtn){
             ...
             String name = Settings.Secure.getString(getContext().getContentResolver(), 
                     Settings.Secure.TASK_MGR_APP);
             if(name != null){
                 String actName =  getActivityName(name);
                 if(actName != null){
                     intent.setClassName(name, actName);
                     getContext().startActivity(intent);
                 }
             }
        }
    ...
    private void updateConfig() {
        ...
        //geesun Add 
        mTaskBtn = (Button)findViewById(com.android.internal.R.id.task_manager);
        ...
        mTaskBtn.setOnClickListener(this);
         ...
         String name = Settings.Secure.getString(getContext().getContentResolver(), 
                 Settings.Secure.TASK_MGR_APP);
         if(name != null){
             mTaskBtn.setVisibility(View.VISIBLE);
         }else{
             mTaskBtn.setVisibility(View.INVISIBLE);
         }
    }
